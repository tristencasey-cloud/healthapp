export function OverviewIcon({ size = 24, color = 'currentColor' }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <polyline points="3,14 8,11 11,13 16,9 21,12" />
    </svg>
  );
}

export function FitnessIcon({ size = 24, color = 'currentColor' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DietIcon({ size = 24, color = 'currentColor' }) {
  return (
    <svg
      width={size}
      height={size}
